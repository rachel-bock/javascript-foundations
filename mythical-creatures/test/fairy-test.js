...
describe('Fairy', () => {
  ...
  it('should get a small amount of fairy dust when others believe in them', () => {
  ...
  it('should get a lot of fairy dust from believeing in themself', () => {
